...
Thank you for your interest in contributing to `coal`.
...
Use the GitHub [issue tracker](https://github.com/coal-library/coal/issues) to report bugs or suggest features.
...
Ask questions in the [discussions section](https://github.com/coal-library/coal/discussions).
