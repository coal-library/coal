...
- Added a fast path for BVH-BVH collision queries when `request.enable_contact = false` and `request.security_margin = 0`. Typically usefull in the context of collision checking in motion planning. ([#858](https://github.com/coal-library/coal/pull/858)
