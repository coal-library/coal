...
- [ ] I have updated the [CHANGELOG](https://github.com/coal-library/coal/blob/devel/CHANGELOG.md) or added the "no changelog" label for CI or infra changes
- [ ] I have updated the [README credits section](https://github.com/coal-library/coal?tab=readme-ov-file#credits)
